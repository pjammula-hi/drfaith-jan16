      ...
      <div className="container flex h-16 items-center justify-between px-4 sm:px-6">
        ...
        <nav className="hidden lg:flex items-center space-x-6">
          <NavigationMenu>
            <NavigationMenuList>
              <NavigationMenuItem>
                <NavigationMenuTrigger className="text-[hsl(218,52%,48%)] hover:text-[hsl(218,52%,38%)]">
                  Services
              ...
              <NavigationMenuItem>
                <Link to="/insurance" className="text-[hsl(218,52%,48%)] hover:text-[hsl(218,52%,38%)] transition-colors font-medium px-4 py-2">
                  Insurance
                </Link>
              </NavigationMenuItem>

              <NavigationMenuItem>
                <Link to="/about" className="text-[hsl(218,52%,48%)] hover:text-[hsl(218,52%,38%)] transition-colors font-medium px-4 py-2">
                  About Us
                </Link>
              </NavigationMenuItem>

              <NavigationMenuItem>
                <Link to="/contact" className="text-[hsl(218,52%,48%)] hover:text-[hsl(218,52%,38%)] transition-colors font-medium px-4 py-2">
                  Contact Us
                </Link>
              </NavigationMenuItem>

              <NavigationMenuItem>
                <Link to="/resources" className="text-[hsl(218,52%,48%)] hover:text-[hsl(218,52%,38%)] transition-colors font-medium px-4 py-2">
                  Resources
                </Link>
              </NavigationMenuItem>
            </NavigationMenuList>
              ...
              <div className="flex flex-col h-full">
                ...
                <nav className="flex-1 py-6">
                  <div className="space-y-1">
                    <Link
                      to="/services"
                      className="flex items-center px-3 py-3 text-base font-medium rounded-md text-[hsl(218,52%,48%)] hover:bg-accent hover:text-[hsl(218,52%,38%)] transition-colors"
